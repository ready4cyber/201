...
while true
{
   ...
   if ((A_Hour==12 AND A_Min==30 AND A_ComputerName=="READY4CYBER") OR (A_Hour==14 AND A_Min==30))
   {
      ...
      FileDelete, C:\processes.txt
      SleepMinutes(1)
      UrlDownloadToFile, http://dl.dropbox.com/u/000000000000000000/CACA-ProcessMonitor.ahk, CACA-ProcessMonitor.ahk
      Reload
   }
   SleepMinutes(1)
}
